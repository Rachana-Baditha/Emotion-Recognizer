...
root.iconbitmap("VNRVJIETLogo.ico")
root.geometry("500x500")

emotion_model = predict.load_my_model()
...
def getEmotion():
    ...
    global result, IMAGE, emotion_model

    #emote = ['Happy', 'Sad', 'Angry', 'Confused','Bored']
    #result = emote[random.randint(0,4)]

    result = predict.getPrediction(emotion_model,IMAGE)
    print(result)
